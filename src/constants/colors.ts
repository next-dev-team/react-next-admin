...
/**
 *   Do not change antdColorToken direct, when app.tsx change antd token the color will be update,
 *  so please copy new update from console.log('theme', theme.useToken()) in react component
 */
export const antdTheme = {
  ...
  colorPrimaryHover: '#ffe057',
  colorPrimaryActive: '#d9aa1c',
  colorPrimaryTextHover: '#ffe057',
  colorPrimaryText: '#fed12e',
  colorPrimaryTextActive: '#d9aa1c',
  ...
  _tokenKey: 'vfhvyd',
  _hashId: 'css-dev-only-do-not-override-10p6xpr',
}
